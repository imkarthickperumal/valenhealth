...
export const metadata: Metadata = {
  ...
  description:
    "Spearwood's EP clinic + 24/7 gym under one roof. Medicare bulk-billed exercise physiology, NDIS, DVA & private health. VALD performance testing. Book online.",
  openGraph: {
  ...
  return (
    <>
        ...
        <div className="hp-hero-inner">
          ...
          <div className="hp-hero-card">
            ...
            <div className="hp-hero-buttons">
              ...
              <ConversionLink
                href="https://valenhealth.bookings.pracsuite.com/guest"
                target="_blank"
      ...
      <section className="hp-stats-bar">
        ...
        <div className="hp-stat">
          <div className="value">EP</div>
          <div className="label">Exercise Physiology</div>
        </div>
        <div className="hp-stat">
          <div className="value">VALD</div>
          <div className="label">Performance Testing</div>
        </div>
        <div className="hp-stat">
      ...
      <section className="hp-paths-section">
        <div className="hp-paths-header">
          ...
          <h2>
            Whatever your goals.
            <br />
            <span className="accent">No matter your journey.</span>
          </h2>
          <p className="lede">
            Whether you&apos;re here to train, recover, or both — every pathway
            leads to the same outcome: a stronger, more capable, more confident
            you.
          </p>
        </div>
          ...
          <div className="hp-feature-strip">
            <div className="hp-feature-strip-grid">
              <div className="hp-feature-strip-lead">
                ...
                <h3>
                  Science you can <span className="accent">measure.</span>
                </h3>
              </div>
              <div className="hp-feature-stat">
                <div className="value">VALD</div>
                <div className="label">Performance Testing</div>
              </div>
              <div className="hp-feature-stat">
                <div className="value">ESSA</div>
                <div className="label">Accredited EPs</div>
              </div>
              <div className="hp-feature-stat">
                <div className="value">24/7</div>
                <div className="label">Facility Access</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hp-paths-cards-wrap">
          <div className="hp-paths-cards">
            <div className="hp-path-card hp-path-card-light">
              <div className="hp-path-icon hp-path-icon-light">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M3 7v10M21 7v10M6 9v6M18 9v6M3 12h18"
                    stroke="#ED6C15"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
              ...
              <h3>The Gym</h3>
              <p className="desc">
                24/7 access to commercial-grade equipment plus the option of
                VALD performance testing. Train freely — measure precisely.
              </p>
              ...
              <div className="footer-row">
                <Link href="/gym">Explore the gym →</Link>
              </div>
            </div>
            ...
            <div className="hp-path-card hp-path-card-cream">
              ...
              <p className="desc">
                Clinical, university-qualified care for chronic conditions,
                injury rehab, and complex recovery. Movement prescribed — not
                guessed.
              </p>
              <div className="features">
              ...
              <div className="footer-row">
                <Link href="/exercise-physiology">Find out more →</Link>
              </div>
            </div>
            ...
            <div className="hp-path-card hp-path-card-dark">
              ...
              <p className="desc">
                Gym + clinic, working as one. Train freely, get clinically
                guided when it counts. The best of both — under one roof.
              </p>
              <div className="features">
              ...
              <div className="footer-row">
                <Link href="/gym#memberships">See memberships →</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="hp-unifier">
        <div className="hp-unifier-content">
          ...
          <div className="hp-unifier-buttons">
            <ConversionNextLink
              href="/contact#contact-form"
              className="btn btn-orange btn-orange-large"
            >
              Book a Tour →
            </ConversionNextLink>
            <ConversionLink
        ...
        <div className="hp-methodology-grid">
          <div className="hp-methodology-left">
            ...
            <h2>
              ...
              Evidence +<br />
              Support =<br />
              <span className="last">lifelong results.</span>
            </h2>
            <p className="desc">
              Every client follows a clear, evidence-based pathway. Rigorous
              enough for clinical outcomes, personal enough for your unique
              journey.
            </p>
          </div>
          <div>
            <div className="hp-methodology-step">
              <div className="num">01</div>
              <div>
                <h4>Assessment</h4>
                <p>
                  Movement screening, health history, goals. We don&apos;t guess
                  — we assess.
                </p>
              </div>
            </div>
            <div className="hp-methodology-step">
              ...
              <div>
                <h4>Prescription</h4>
                <p>
                  Built specifically for your body, your condition, your goals.
            ...
            <div className="hp-methodology-step">
              ...
              <div>
                <h4>Progress</h4>
                <p>
                  VALD performance testing means your progress is measured — not
                  assumed.
                </p>
              </div>
            </div>
            <div className="hp-methodology-step">
              ...
              <div>
                <h4>Sustained Results</h4>
                <p>
                  We don&apos;t stop when you feel better. We keep going until
                  you thrive for life.
                </p>
              </div>
            </div>
      ...
      <section className="hp-referral-strip">
        <div className="hp-referral-strip-inner">
          <div className="hp-referral-strip-msg">
            ...
            <span className="lead">
              Doctors refer to us. So do their patients.
            </span>
            <span className="sub">
              Trusted by local GPs, surgeons &amp; insurers.
            </span>
          </div>
      ...
      <section className="hp-funding-band">
        <div className="hp-funding-band-inner">
          <div className="hp-funding-band-eyebrow">
            — Accepted Funding &amp; Referral Pathways —
          </div>
          <div className="hp-funding-band-list">
            <span className="item">Medicare</span>
            <span className="sep"></span>
            <span className="item">NDIS</span>
            <span className="sep"></span>
            <span className="item">DVA</span>
            <span className="sep"></span>
            <span className="item">WorkCover WA</span>
            <span className="sep"></span>
      ...
      <section className="hp-final-cta">
        <div className="hp-final-cta-content">
          <h2>
            Ready to move<span className="accent">with purpose?</span>
          </h2>
          <p className="lede">
            Book a tour of the facility, or book a clinical EP consultation.
            Whichever path you choose — we&apos;re with you.
          </p>
